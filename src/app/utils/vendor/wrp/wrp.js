...
const Wrp = (function () {
  ...
  function connect_() {
    if (state_ !== 0) {
      if (wrp_.TRACE)
        wrp_.TRACE(
          "ERROR: can't connect to WebSocket server (Invalid state: " +
            state_ +
            ')'
        )
      return false
    ...
    if (!wrp_.serverURL) {
      if (wrp_.TRACE)
        wrp_.TRACE(
          "ERROR: can't connect to WebSocket server (Missing server URL)"
        )
      if (wrp_.disconnectEnded) wrp_.disconnectEnded()
      return true
    }
    try {
      ...
      if (wrp_.TRACE)
        wrp_.TRACE(
          "ERROR: can't connect to WebSocket server (" + e.message + ')'
        )
      if (wrp_.disconnectEnded) wrp_.disconnectEnded()
      return true
    }
    ...
    socket_.onopen = function (event) {
      state_ = 2
      if (wrp_.TRACE)
        wrp_.TRACE('INFO: connected to WebSocket server: ' + wrp_.serverURL)
    ...
    socket_.onclose = function (event) {
      if (state_ === 1) {
        ...
        if (wrp_.TRACE)
          wrp_.TRACE(
            "ERROR: can't connect to WebSocket server: " + wrp_.serverURL
          )
        if (wrp_.disconnectEnded) wrp_.disconnectEnded()
        interlock_ = false
      } else if (state_ === 2) {
      ...
      if (tag === 's') {
        if (body) {
          if (state_ === 2) {
            ...
            if (wrp_.TRACE)
              wrp_.TRACE(
                "ERROR: can't start feeding data to WebSocket server (" +
                  body +
                  ')'
              )
            if (wrp_.disconnectStarted) wrp_.disconnectStarted()
          ...
          if (state_ === 4) {
            state_ = 5
            if (wrp_.TRACE)
              wrp_.TRACE('INFO: started feeding data to WebSocket server')
        ...
        if (body) {
          if (state_ === 2) {
            ...
            if (wrp_.TRACE)
              wrp_.TRACE(
                "ERROR: can't feed data to WebSocket server (" + body + ')'
              )
            if (wrp_.disconnectStarted) wrp_.disconnectStarted()
            socket_.close()
          } else if (state_ === 3) {
        ...
        if (body) {
          if (state_ === 2) {
            ...
            if (wrp_.TRACE)
              wrp_.TRACE(
                "ERROR: can't stop feeding data to WebSocket server (" +
                  body +
                  ')'
              )
            if (wrp_.disconnectStarted) wrp_.disconnectStarted()
          ...
          if (state_ === 6) {
            ...
            stopCheckIntervalTimeoutTimer_()
            if (wrp_.TRACE)
              wrp_.TRACE('INFO: stopped feeding data to WebSocket server')
            if (recorder_) {
              recorder_.pause()
            } else {
              state_ = 2
              if (wrp_.feedDataPauseEnded)
                wrp_.feedDataPauseEnded({ code: 0, message: '' })
            }
          } else if (state_ === 36) {
            state_ = 2
            stopCheckIntervalTimeoutTimer_()
        ...
        if (wrp_.resultFinalized)
          wrp_.resultFinalized('\x01\x01\x01\x01\x01' + body)
        startCheckIntervalTimeoutTimer_()
      } else if (tag === 'Q') {
  ...
  function disconnect_() {
    ...
    if (state_ !== 2) {
      if (wrp_.TRACE)
        wrp_.TRACE(
          "ERROR: can't disconnect from WebSocket server (Invalid state: " +
            state_ +
            ')'
        )
      return false
  ...
  async function feedDataResume_() {
    ...
    if (state_ !== 2) {
      if (wrp_.TRACE)
        wrp_.TRACE(
          "ERROR: can't start feeding data to WebSocket server (Invalid state: " +
            state_ +
            ')'
        )
      return false
  ...
  function feedDataResume__() {
    if (wrp_.grammarFileNamesElement)
      wrp_.grammarFileNames = wrp_.grammarFileNamesElement.value
    if (wrp_.profileIdElement) wrp_.profileId = wrp_.profileIdElement.value
    if (wrp_.profileWordsElement)
      wrp_.profileWords = wrp_.profileWordsElement.value
    if (wrp_.segmenterPropertiesElement)
      wrp_.segmenterProperties = wrp_.segmenterPropertiesElement.value
    if (wrp_.keepFillerTokenElement)
      wrp_.keepFillerToken = wrp_.keepFillerTokenElement.value
    if (wrp_.resultUpdatedIntervalElement)
      wrp_.resultUpdatedInterval = wrp_.resultUpdatedIntervalElement.value
    if (wrp_.extensionElement) wrp_.extension = wrp_.extensionElement.value
    if (wrp_.authorizationElement)
      wrp_.authorization = wrp_.authorizationElement.value
    ...
    if (wrp_.checkIntervalTimeElement)
      wrp_.checkIntervalTime = wrp_.checkIntervalTimeElement.value - 0
    var command = 's '
    if (wrp_.codec) {
      command += wrp_.codec
    } else {
    ...
    if (wrp_.grammarFileNames) {
      ...
      if (
        wrp_.grammarFileNames.indexOf('\x01') != -1 &&
        !wrp_.grammarFileNames.endsWith('\x01')
      ) {
        command += '\x01'
      }
    } else {
    ...
    if (wrp_.segmenterProperties) {
      command +=
        ' segmenterProperties="' +
        wrp_.segmenterProperties.replace(/"/g, '""') +
        '"'
    }
  ...
  function feedData_(data) {
    if (state_ !== 5) {
      if (wrp_.TRACE)
        wrp_.TRACE(
          "ERROR: can't feed data to WebSocket server (Invalid state: " +
            state_ +
            ')'
        )
      return false
  ...
  function feedDataPause_() {
    if (state_ !== 5) {
      if (wrp_.TRACE)
        wrp_.TRACE(
          "ERROR: can't stop feeding data to WebSocket server (Invalid state: " +
            state_ +
            ')'
        )
      return false
  ...
  function startCheckIntervalTimeoutTimer_() {
    ...
    stopCheckIntervalTimeoutTimer_()
    checkIntervalTimeoutTimerId_ = setTimeout(
      fireCheckIntervalTimeoutTimer_,
      wrp_.checkIntervalTime - 1000
    )
    if (wrp_.TRACE)
      wrp_.TRACE(
        'INFO: started check interval time timer: ' +
          wrp_.checkIntervalTime +
          '(-1000)'
      )
  }
  ...
  function stopCheckIntervalTimeoutTimer_() {
    if (checkIntervalTimeoutTimerId_ !== null) {
      ...
      if (wrp_.TRACE)
        wrp_.TRACE(
          'INFO: stopped check interval time timer: ' +
            wrp_.checkIntervalTime +
            '(-1000)'
        )
    }
  ...
  function fireCheckIntervalTimeoutTimer_() {
    if (wrp_.TRACE)
      wrp_.TRACE(
        'INFO: fired check interval time timer: ' +
          wrp_.checkIntervalTime +
          '(-1000)'
      )
    feedDataPause_()
  ...
  function issue_() {
    if (!window.XMLHttpRequest) {
      if (wrp_.TRACE)
        wrp_.TRACE(
          "ERROR: can't issue service authorization (Unsupported XMLHttpRequest class)"
        )
      return false
    }
    ...
    if (!wrp_.sid) {
      if (wrp_.TRACE)
        wrp_.TRACE(
          "ERROR: can't issue service authorization (Missing service id)"
        )
    ...
    for (var i = 0; i < wrp_.sid.length; i++) {
      ...
      if (
        ...
        if (wrp_.TRACE)
          wrp_.TRACE(
            "ERROR: can't issue service authorization (Illegal char in service id)"
          )
        if (wrp_.sidElement)
          alert('サービス ID に許されていない文字が使用されています。')
        if (wrp_.sidElement) wrp_.sidElement.focus()
        return false
      }
    }
    if (!wrp_.spw) {
      if (wrp_.TRACE)
        wrp_.TRACE(
          "ERROR: can't issue service authorization (Missing service password)"
        )
    ...
    for (var i = 0; i < wrp_.spw.length; i++) {
      ...
      if (c < 0x20 || c > 0x7e) {
        if (wrp_.TRACE)
          wrp_.TRACE(
            "ERROR: can't issue service authorization (Illegal char in service password)"
          )
        if (wrp_.spwElement)
          alert('サービスパスワードに許されていない文字が使用されています。')
        if (wrp_.spwElement) wrp_.spwElement.focus()
        return false
      }
    }
    for (var i = 0; i < wrp_.epi.length; i++) {
      ...
      if (c < 0x30 || c > 0x39) {
        if (wrp_.TRACE)
          wrp_.TRACE(
            "ERROR: can't issue service authorization (Illegal char in pexires in)"
          )
        if (wrp_.epiElement)
          alert('有効期限に許されていない文字が使用されています。')
    ...
    var searchParams =
      'sid=' +
      encodeURIComponent(wrp_.sid) +
      '&spw=' +
      encodeURIComponent(wrp_.spw)
    if (wrp_.epi) {
    ...
    httpRequest.addEventListener('load', function (e) {
      if (e.target.status === 200) {
        ...
        } else if (wrp_.authorizationElement) {
  ...
  wrp_.serverURL = wrp_.serverURL.substring(
    0,
    wrp_.serverURL.lastIndexOf('/') + 1
  )
